...
public class TestThreadRunnable implements Runnable {
	...
	@Override
	public void run() {
		System.out.println(ldt + ":This is currently running on a separate thread, " + "the id is: " + Thread.currentThread().getId()+ ",with Name" :" + Thread.currentThread(.getName()+ ",with Priority :" + Thread.currentThread().getPriority());
	}
